...
public class MedicineFormController {
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = medicineBO.save(new MedicineDTO(id,name,type,price,description,qtyOnHand));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = medicineBO.update(new MedicineDTO(id,name,type,price,description,qtyOnHand));
            if(isUpdated){
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = medicineBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllMedicine() {
        ...
        try {
            ...
            List<MedicineDTO>medicineList=medicineBO.getAll();
