...
public class AppointmentFormController {
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        AppointmentDTO appointment =appointmentBO.searchById(id);
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = appointmentBO.save(new AppointmentDTO(id,clientId,no,date,time));
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = appointmentBO.update(new AppointmentDTO(id,clientId,no,date,time));
    ...
    private void loadAllAppointments() {
        ...
        try {
            ...
            List<AppointmentDTO>appointmentList=appointmentBO.getAll();
