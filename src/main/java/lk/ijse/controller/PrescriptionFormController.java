...
public class PrescriptionFormController {
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        PrescriptionDTO prescription = prescriptionBO.searchById(id);
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = prescriptionBO.save(new PrescriptionDTO(id,type,veterinarianId));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = prescriptionBO.update(new PrescriptionDTO(id,type,veterinarianId));
            if(isUpdated){
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = prescriptionBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllPrescriptions() {
        ...
        try {
            ...
            List<PrescriptionDTO>prescriptionList=prescriptionBO.getAll();

            for (PrescriptionDTO prescription : prescriptionList) {
                PrescriptionTm tm = new PrescriptionTm(
                        prescription.getId(),
                        prescription.getType(),
                        prescription.getVeterinarianId()
