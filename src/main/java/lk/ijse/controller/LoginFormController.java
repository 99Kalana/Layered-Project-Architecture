...
public class LoginFormController {
    ...
    public void btnLoginOnAction(ActionEvent actionEvent) throws IOException {
        ...
        try{
            checkCredential(userId,password,rootNode);
        }catch(SQLException e){
            new Alert(Alert.AlertType.ERROR,e.getMessage()).show();
        }
    }

    private void checkCredential(String userId,String password,AnchorPane rootNode) throws SQLException, IOException {
        loginBO.checkCredential(userId, password,rootNode);
    }
