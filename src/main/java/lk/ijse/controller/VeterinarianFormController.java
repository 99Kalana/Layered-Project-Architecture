...
public class VeterinarianFormController {
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        VeterinarianDTO veterinarian = veterinarianBO.searchById(id);
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = veterinarianBO.save(new VeterinarianDTO(id,name,contactNo,email));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = veterinarianBO.update(new VeterinarianDTO(id,name,contactNo,email));
            if(isUpdated){
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = veterinarianBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllVeterinarian() {
        ...
        try {
            ...
            List<VeterinarianDTO>veterinarianList = veterinarianBO.getAll();

            for (VeterinarianDTO veterinarian : veterinarianList) {
                VeterinarianTm tm = new VeterinarianTm(
                        veterinarian.getId(),
                        veterinarian.getName(),
                        veterinarian.getContactNo(),
