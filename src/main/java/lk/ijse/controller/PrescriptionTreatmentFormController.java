...
public class PrescriptionTreatmentFormController {
    ...
    PrescriptionTreatmentBO prescriptionTreatmentBO = (PrescriptionTreatmentBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.PRESCRIPTION_TREATMENT);
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        PrescriptionTreatmentDTO prescriptionTreatment = prescriptionTreatmentBO.searchById(id);
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = prescriptionTreatmentBO.save(new PrescriptionTreatmentDTO(pId,tId,price,date,time));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = prescriptionTreatmentBO.update(new PrescriptionTreatmentDTO(pId,tId,price,date,time));
            if(isUpdated){
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = prescriptionTreatmentBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllPrescriptionTreatments() {
        ...
        try {
            ...
            List<PrescriptionTreatmentDTO>prescriptionTreatmentList= prescriptionTreatmentBO.getAll();

            for (PrescriptionTreatmentDTO prescriptionTreatment : prescriptionTreatmentList) {
                PrescriptionTreatmentTm tm = new PrescriptionTreatmentTm(
                        prescriptionTreatment.getpId(),
                        prescriptionTreatment.gettId(),
                        prescriptionTreatment.getPrice(),
