...
public class TreatmentsFormController {
    ...
    TreatmentsBO treatmentsBO = (TreatmentsBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.TREATMENTS);
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        TreatmentsDTO treatments = treatmentsBO.searchById(id);
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = treatmentsBO.save(new TreatmentsDTO(id,type,description));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = treatmentsBO.update(new TreatmentsDTO(id,type,description));
            if(isUpdated){
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = treatmentsBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllTreatments() {
        ...
        try {
            ...
            List<TreatmentsDTO>treatmentsList=treatmentsBO.getAll();

            for (TreatmentsDTO treatments : treatmentsList) {
                TreatmentsTm tm = new TreatmentsTm(
                        treatments.getId(),
                        treatments.getType(),
                        treatments.getDescription()
