...
public class BillDetailFormController {
    ...
    BillsDetailsBO billsDetailsBO = (BillsDetailsBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.BILL_DETAILS);
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        BillsDetailsDTO billsDetails = billsDetailsBO.searchById(id);
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = billsDetailsBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllBillDetails() {
        ...
        try {
            ...
            List<BillsDetailsDTO>billsDetailsList=billsDetailsBO.getAll();

            for (BillsDetailsDTO billsDetails : billsDetailsList) {
                BillsDetailsTm tm = new BillsDetailsTm(
                        billsDetails.getBillId(),
                        billsDetails.getMedicineId(),
                        billsDetails.getMedicineQty(),
