...
public class ResetPasswordFormController {
    ...
    ResetPasswordBO resetPasswordBO = (ResetPasswordBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.RESET_PASSWORD);
    ...
    private boolean isValidUser(String userId, String name) throws SQLException {
        ...
        return resetPasswordBO.isValidUser(userId, name);
    ...
    private boolean resetPassword(String userId,String newPassword) throws SQLException {
        ...
        return resetPasswordBO.resetPassword(userId, newPassword);
