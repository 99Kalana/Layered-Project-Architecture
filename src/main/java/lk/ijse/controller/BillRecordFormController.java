...
public class BillRecordFormController {
    ...
    BillRecordBO billRecordBO = (BillRecordBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.BILL_RECORD);
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        BillRecordDTO billRecord = billRecordBO.searchById(id);
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = billRecordBO.delete(id);
    ...
    private void loadBillRecords() {
        ...
        try {
            ...
            List<BillRecordDTO>billRecordList =billRecordBO.getAll();

            for (BillRecordDTO billRecord : billRecordList) {
                BillRecordTm tm = new BillRecordTm(
                        billRecord.getBillId(),
                        billRecord.getClientId(),
                        billRecord.getDate()
