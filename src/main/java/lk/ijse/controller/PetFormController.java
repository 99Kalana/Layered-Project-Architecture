...
public class PetFormController {
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        ...
        try{
            ...
            boolean isSaved = petBO.save(new PetDTO(id,name,breed,weight,colour));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try{
            ...
            boolean isUpdated = petBO.update(new PetDTO(id,name,breed,weight,colour));
            if(isUpdated){
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        PetDTO pet = petBO.searchById(id);
    ...
    private void loadAllPets() {
        ...
        try {
            ...
            List<PetDTO>petList = petBO.getAll();
