...
public class BillFormController {
    ...
    VeterinarianBO veterinarianBO = (VeterinarianBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.VETERINARIAN);
    ...
    PlaceBillBO placeBillBO = (PlaceBillBO) BOFactory.getBoFactory().getBo(BOFactory.BOTypes.PLACE_BILL);
    ...
    private void getCurrentBillId() {
        try {
            ...
            String currentBillId = billBO.getCurrentBillId();
    ...
    private void getClientIds() {
        ...
        try {
            ...
            List<String>idList = clientBO.getIds();
    ...
    public void cmbClientOnAction(ActionEvent event) {
        ...
        try {
            ...
            ClientDTO client = clientBO.searchById(clientId);
    ...
    private void getPetIds() {
        ...
        try {
            ...
            List<String> idList = petBO.getIds();
    ...
    public void cmbPetOnAction(ActionEvent event)  {
        ...
        try {
            ...
            PetDTO pet = petBO.searchById(petId);
    ...
    private void getVeterinarianIds() {
        ...
        try {
            ...
            List<String>idList=veterinarianBO.getIds();
    ...
    public void cmbVeterinarianOnAction(ActionEvent event) {
        ...
        try {
            ...
            VeterinarianDTO veterinarian = veterinarianBO.searchById(veterinarianId);
    ...
    private void getMedicineIds() {
        ...
        try {
            ...
            List<String>idList=medicineBO.getIds();
    ...
    public void cmbMedicineOnAction(ActionEvent event) {
        ...
        try {
            ...
            MedicineDTO medicine = medicineBO.searchById(id);
            if(medicine != null) {
    ...
    public void btnPlaceBillOnAction(ActionEvent event) {
        ...
        //var bill = new BillDTO(billId,clientId,date);

        BillDTO bill = new BillDTO(billId,clientId,date);

        List<BillDetailDTO> billList = new ArrayList<>();

        for(int i = 0; i < tblBill.getItems().size(); i++){

            BillFormTm tm = obList.get(i);

            BillDetailDTO bd = new BillDetailDTO(
                    billId,
                    tm.getMId(),
                    tm.getMQty(),
                    tm.getMPrice()
        ...
        try {
            ...
            boolean  isPlaced = placeBillBO.placeBill(new PlaceBillDTO(bill,billList));
            if (isPlaced){
