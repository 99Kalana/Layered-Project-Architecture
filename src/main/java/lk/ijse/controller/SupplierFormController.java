...
public class SupplierFormController {
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = supplierBO.save(new SupplierDTO(id,name,contactNo,location,email,productType,qtyOnHand));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = supplierBO.update(new SupplierDTO(id,name,contactNo,location,email,productType,qtyOnHand));
            if(isUpdated){
