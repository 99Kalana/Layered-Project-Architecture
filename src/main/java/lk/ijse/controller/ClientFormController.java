...
public class ClientFormController {
    ...
    public void txtSearchOnAction(ActionEvent event) throws SQLException {
        ...
        ClientDTO client = clientBO.searchById(id);
    ...
    public void btnSaveOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isSaved = clientBO.save(new ClientDTO(id,petId,name,address,email,contactNo));
            if(isSaved){
    ...
    public void btnUpdateOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isUpdated = clientBO.update(new ClientDTO(id,petId,name,address,email,contactNo));
            if(isUpdated){
    ...
    public void btnDeleteOnAction(ActionEvent event) {
        ...
        try{
            ...
            boolean isDeleted = clientBO.delete(id);
            if (isDeleted){
    ...
    private void loadAllClients() {
        ...
        try {
            ...
            List<ClientDTO>clientList = clientBO.getAll();
